...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Império de Ideias — Estratégia que vira execução" },
      ...
      { property: "og:description", content: "Agência estratégica de branding, marketing, comunicação, design, SEO, GEO, AEO e IA. Da criação ao crescimento — com clareza, consistência e foco em resultado." },
      { name: "twitter:description", content: "Agência estratégica de branding, marketing, comunicação, design, SEO, GEO, AEO e IA. Da criação ao crescimento — com clareza, consistência e foco em resultado." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f09f1350-50d0-40b1-9a36-27678b777962/id-preview-90df08d7--6ec4378a-a637-425f-8436-78caed7fa8bd.lovable.app-1783352165996.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f09f1350-50d0-40b1-9a36-27678b777962/id-preview-90df08d7--6ec4378a-a637-425f-8436-78caed7fa8bd.lovable.app-1783352165996.png" },
    ],
    links: [
